...
class ScrollableModified extends StatefulWidget {
  /// Creates a widget that scrolls.
  ///
  /// The [axisDirection] and [viewportBuilder] arguments must not be null.
  const ScrollableModified({
    Key? key,
  ...
  static Future<void> ensureVisible(
    ...
    while (scrollable != null) {
      ...
      scrollable = ScrollableModified.of(context);
    }
      ...
      switch (widget.axis) {
        case Axis.vertical:
          _gestureRecognizers = <Type, GestureRecognizerFactory>{
            _VerticalDragGestureRecognizerIgnoringMultitouch:
                GestureRecognizerFactoryWithHandlers<
                    _VerticalDragGestureRecognizerIgnoringMultitouch>(
              () => _VerticalDragGestureRecognizerIgnoringMultitouch(
                  supportedDevices: _configuration.dragDevices),
              (_VerticalDragGestureRecognizerIgnoringMultitouch instance) {
                instance
        ...
        case Axis.horizontal:
          _gestureRecognizers = <Type, GestureRecognizerFactory>{
            _HorizontalDragGestureRecognizerIgnoringMultitouch:
                GestureRecognizerFactoryWithHandlers<
                    _HorizontalDragGestureRecognizerIgnoringMultitouch>(
              () => _HorizontalDragGestureRecognizerIgnoringMultitouch(
                  supportedDevices: _configuration.dragDevices),
              (_HorizontalDragGestureRecognizerIgnoringMultitouch instance) {
                instance
                  ..onDown = _handleDragDown
                  ..onStart = _handleDragStart
                  ..onUpdate = _handleDragUpdate
...
class _HorizontalDragGestureRecognizerIgnoringMultitouch
...
class _VerticalDragGestureRecognizerIgnoringMultitouch
